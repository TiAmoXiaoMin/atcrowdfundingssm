<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%> <!-- 当前页面的编码 -->
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
  <!--   <meta charset="UTF-8"> -->
  	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"> <!-- 告诉浏览器端要显示的编码 -->
			...
			<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			  <div class="container">
				<div class="navbar-header">
				  <a class="navbar-brand" href="index.html" style="font-size:32px;">Shangchou.com - crowdfunding platform for creative products</a>
				</div>
